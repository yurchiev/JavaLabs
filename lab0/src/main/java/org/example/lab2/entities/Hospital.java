...
public class Hospital {
    ...
    public static class HospitalBuilder
    {
        ...
        public Hospital.HospitalBuilder setNumberOfHospital(int numberOfHospital) {
            this.numberOfHospital = numberOfHospital;
            return this;
        }
        ...
        public Hospital build() {
            ...
            Set<ConstraintViolation<HospitalBuilder>> constraintViolations = validator.validate(this);
