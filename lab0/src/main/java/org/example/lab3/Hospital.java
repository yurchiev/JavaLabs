...
public class Hospital {
    public String numberOfHospital;
    public String numberOfRoom;
    public String location;

    public Hospital(){}

    public Hospital(String numberOfHospital, String numberOfRoom, String location) {
    ...
    public void setHospitalNumber(String numberOfHospital) {
        this.numberOfHospital = numberOfHospital;
    }
    ...
    public static class HospitalBuilder
    {
        ...
        public Hospital.HospitalBuilder setNumberOfHospital(String numberOfHospital) {
            this.numberOfHospital = numberOfHospital;
            return this;
        }
